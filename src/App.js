  ...
  return (
    <>
      ...
      <Switch>
          ...
          <Route exact path="/edit-store-manager.component/" component={CreateStoreManager}/>
          <Route exact path="/customer-list.component/" component={UsersList} />
          <Route exact path="/create-store-manager.component/" component={CreateStoreManager}/>
          <Route exact path="/store-manager-list.component/" component={UsersList}/>
